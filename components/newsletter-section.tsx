...
export function NewsletterSection() {
  ...
  return (
    <section className="w-full bg-[#0f90d6] shadow-[0px_0px_60px_#0000000d] relative py-12 md:py-16">
      <div className="container mx-auto px-4 md:px-8 lg:px-[154px]">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
          ...
          <div className="flex-shrink-0 text-center lg:text-left">
            ...
            <p className="font-['Jost'] text-white/90 text-sm md:text-base mt-2">{t("newsletter.subtitle")}</p>
          </div>
