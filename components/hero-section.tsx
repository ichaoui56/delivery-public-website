  ...
  return (
    ...
    >
      ...
      <div
        ...
        } ${locale === "ar" ? "right-0" : "left-0"} top-1/2 -translate-y-1/2 z-50 flex flex-col gap-4 ${locale === "ar" ? "pr-6" : "pl-6"} transition-all duration-300`}
      >
        <div className="w-px h-16 bg-gray-800 mx-auto" />
        <a
          href="#"
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <ScrollAnimation delay={0.6} duration={0.8}>
          ...
          <div className="flex items-center justify-center gap-3">
            ...
            <div>
              <div className="text-4xl font-bold text-white" style={{ fontFamily: "Rajdhani, sans-serif" }}>
                {t.stat1}
              </div>
              <div className="text-sm text-white/90" style={{ fontFamily: "Jost, sans-serif" }}>
                {t.deliveredPackage}
              </div>
            </div>
          </div>
